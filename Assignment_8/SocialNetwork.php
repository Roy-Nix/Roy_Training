...
<body style="background-color: #ffe1c3;">
	<div class="container-fluid">
		<div class="jumbotron">
			<h1 style="text-align: center;"><?php echo "$currentUser"; ?>
		...
		<div class="row">
			...
			<div class="col-sm-9">
					<form class="form-group"  method="post">
						Write Something about yourself!!<br><br><textarea rows="7" cols="120" class="form-control" name="postsomething" required></textarea>
						<br>
